...
class CanadaNetCDFToDGGSConverterAggregated:
    """
    Convert Canada NetCDF files to DGGS grid values using aggregated raster-first processing.
    ...
    def _load_ipcc_lookup(self):
        """Load the IPCC2006 variable lookup table."""
        lookup_path = "data/lookup/canada_netcdf_variable_lookup.csv"
    ...
    def convert_aggregated_to_raster(self, netcdf_path):
        ...
        for ipcc_code, aggregated_array in aggregated_data.items():
            ...
            if area is not None:
                ...
                total_emission_per_pixel = aggregated_array_mg_per_m2 * area
            else:
    ...
    def process_all_netcdf_files(self):
        ...
        # Add Year column with value 2018
        result_df['Year'] = 2018
        ...
        # Save to single CSV
        output_filename = "Canada_DGGS_methane_emissions_ALL_FILES.csv"
